...
$sql_interest="SELECT interest_field FROM User WHERE user_id = '22'" ;
$sql_orderbyLatest="";
$sql_orderbyAlpha="";
$sql_orderbyRate="";
...
if($result_interest){
   $interest = mysqli_fetch_object($result_interest)->interest_field;
   mysqli_free_result($result_interest);
 }
...
if($interest!=""){
    $sql_interest ="
      ORDER BY (CASE WHEN category1 = '$interest' THEN 0 ELSE 1 END)";
      $sql.=$sql_interest;
  }
